...
namespace PetLand.BAL.Services.Implements
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(ProductReponsitory productRepository, IUnitOfWork unitOfWork, PetLandContext context)
        {
            _context = context;
        ...
        public List<ProductViewModel> GetAll(string? keywords, List<string>? sortby, int PAGE_SIZE, int page = 1)
        {
            ...
            var list = _productReponsitory.GetAllProdcut(keywords, sortby, PAGE_SIZE, page);
